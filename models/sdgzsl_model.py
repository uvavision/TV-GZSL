...
class SDGZSL_VAE(nn.Module):
    def __init__(self, args):
        super(SDGZSL_VAE, self).__init__()
...
class SDGZSL_RelationNet(nn.Module):
    def __init__(self, args):
        super(SDGZSL_RelationNet, self).__init__()
...
class SDGZSL_Discriminator(nn.Module):
    def __init__(self, args):
        super(SDGZSL_Discriminator, self).__init__()
